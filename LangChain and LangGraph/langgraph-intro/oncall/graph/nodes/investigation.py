...
def tools_node(state: IncidentState, config) -> dict:
    ...
    # wrapping aound LangGraph's built in tool node to add our own functionality: the trace property in our state
